 ...
 *
 *        Version:  1.0
 *        Created:  09/25/2019 01:05:27 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
int fifo_write_one_packet(fifo_t *fifo, u8 *header, u8 *packet_addr, u32 packet_size)
{
    ...
    // fill the entry
    fifo->packet_info_entries[entry_index_for_this_write].packet_addr = packet_addr;//addr_for_this_write;
 ...
 *
 * \param[in]  fifo
 * \param[in]  header           bs_info_t
 * \param[in]  packet_addr
